...
const UserProfile = ({bio}) => (
  <div>
    ...
    {bio.email && <li className="list-group-item">Email: <a href="mailto:{bio.email}">{bio.email}</a></li>}
    ...
    {bio.public && <li className="list-group-item">Public Repos: {bio.public_repos}</li>}
